        ...
        <div className='min-w-screen h-screen bg-[#70675F] font-cherry overflow-x-hidden'>
            <div className='flex flex-col md:flex-row'>
                <div className='text-white pl-[5vw] leading-snug fadeIn'>
                    ...
                    <Link to="/Home">     
                        <button 
                            className='mt-[10vw] md:mt-[3vw] rounded-xl w-[171px] h-[75px] text-[18px] font-poppins bg-[#AE967F] font-bold rounded-md shadow hover:bg-gray-200 active:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500'
                            aria-label='Button'>
                            Get Started
                        </button>
                    </Link>
